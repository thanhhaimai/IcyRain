 ...
 * to get started adding custom/advanced routes narratives to your application. It shows how to
 * digest the route information and create narrative from it. It depends on two layout files:<br/>
 * <li/>custom_route_itinerary.xml used to describe what the route itinerary looks <li/>
 * custom_route_manuever.xml that describes what each maneuver looks like in the listView This class
 * gets wired up in the custom_route_itinerary_demo.xml layout ( look for
...
public class RouteItineraryView extends RelativeLayout {
  ...
  public void setRouteResponse(RouteResponse routeResponse) {
    ...
    ManueverArrayAdapter arrayAdapter =
      new ManueverArrayAdapter(narrativeList.getContext(), R.layout.custom_route_manuver,
        routeResponse);
  ...
  public class ManueverArrayAdapter extends ArrayAdapter<Maneuver> {
    ...
    public ManueverArrayAdapter(Context context, int textViewResourceId, RouteResponse routeResponse) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
      ...
      if (convertView == null) {
        ...
        holder.roadShieldContainer =
          (LinearLayout) convertView.findViewById(R.id.roadShieldContainer);
